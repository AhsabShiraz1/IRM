...
export default function IrmConclusion({ setNotification, setCurrentLevel }: LevelProps) {
  ...
  const questions: Question[] = [
    {
      ...
      options: ["Trolley Loading System", "Traceable Logistics Software", "Truck Loading Station", "Transport and Logistics System"],
      values: [0, 0, 1, 0],
    },
    {
      question: "What is the process of storing coal in stackyard called",
      options: ["Berthing", "stacking", "storing", "sorting"],
      values: [1, 0, 0, 0],
    },
    {
      question: "What is the full form of WLS",
      options: ["Washing and Loading Schedule", "Wagon Loading System", "Washery and Loader System", "Warehouse & Logistics Storage"],
      values: [0, 1, 0, 0],
    },
    {
      question: " Coal is transported to mundra port by",
      options: ["Container ship", "storage ship", "Vessel", "Barge"],
      values: [0, 0, 1, 0],
    }
  ];

  useEffect(() => {
    setNotification("This marks the end of IRM module. Please enter your session ID to begin.");
  ...
  const handleOptionClick = (index: number) => {
    ...
    localStorage.setItem(`IRM-${sessionId}-question${currentQuestionIndex + 1}`, isCorrect ? "1" : "0");
          ...
          <Root>
            ...
            >
              <Container flexDirection="column" alignItems="flex-start">
                <Text fontSize={12} fontWeight="bold">
                  You have answered the questions on the IRM module. Please click on the button to continue.
                </Text>
                <Text fontSize={12} fontWeight="bold">
